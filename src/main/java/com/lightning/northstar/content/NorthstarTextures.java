...
public class NorthstarTextures {
    ...
    public static final ResourceLocation MOON_FLAT = Northstar.asResource("textures/environment/moon_flat.png");
    ...
    public static final ResourceLocation MERCURY_FAR = Northstar.asResource("textures/environment/mercury_far.png");
    ...
    public static final ResourceLocation JUPITER_FAR = Northstar.asResource("textures/environment/jupiter_far.png");
    public static final ResourceLocation SATURN_FAR = Northstar.asResource("textures/environment/saturn_far.png");
    public static final ResourceLocation URANUS_FAR = Northstar.asResource("textures/environment/uranus_far.png");
    public static final ResourceLocation NEPTUNE_FAR = Northstar.asResource("textures/environment/neptune_far.png");
    public static final ResourceLocation PLUTO_FAR = Northstar.asResource("textures/environment/pluto_far.png");
    public static final ResourceLocation ERIS_FAR = Northstar.asResource("textures/environment/eris_far.png");
    public static final ResourceLocation CERES_FAR = Northstar.asResource("textures/environment/ceres_far.png");

...
public class MarsRootsConfig implements FeatureConfiguration {
       public static final Codec<MarsRootsConfig> CODEC = RecordCodecBuilder.create((p_198371_) -> p_198371_.group(PlacedFeature.CODEC.fieldOf("feature").forGetter((p_204840_) -> {

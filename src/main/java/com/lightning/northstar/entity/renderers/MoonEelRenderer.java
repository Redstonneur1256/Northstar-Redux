...
public class MoonEelRenderer extends GeoEntityRenderer<MoonEelEntity> {
    ...
    public MoonEelRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DefaultedEntityGeoModel<>(NorthstarEntityResources.EEL_MODEL, true));
    }

    @Override
    public RenderType getRenderType(MoonEelEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {

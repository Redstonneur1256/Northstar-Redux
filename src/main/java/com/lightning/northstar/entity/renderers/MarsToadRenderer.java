...
public class MarsToadRenderer extends GeoEntityRenderer<MarsToadEntity> {
    ...
    public MarsToadRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DefaultedEntityGeoModel<>(NorthstarEntityResources.TOAD_MODEL, true));
    }

    @Override
    public RenderType getRenderType(MarsToadEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {

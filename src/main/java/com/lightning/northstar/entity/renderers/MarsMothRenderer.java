...
public class MarsMothRenderer extends GeoEntityRenderer<MarsMothEntity> {
    ...
    public MarsMothRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DefaultedEntityGeoModel<>(NorthstarEntityResources.MOTH_MODEL, true));
    }

    @Override
    public RenderType getRenderType(MarsMothEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
